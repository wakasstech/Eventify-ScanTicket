      ...
      <div className="mt-1 flex flex-col">
        <div className="hidden sm:block" >
          <div href="#" className="flex item-center inset-0">
            <img src="../src/assets/img-home.jpg" alt="" style={{ width: '100%', height: 350}}/> 
          </div>
        </div>
        ...
        {events.length > 0 && events.map((event) => {
          ...
          // if (eventDate > currentDate || eventDate.toDateString() === currentDate.toDateString()){
            ...
            return (
              <div className="bg-white rounded-xl relative" key={event._id} style={{border: '1px solid #c2c2fd',}}>
              ...
              {event.image && (
                ...
                {/* <img src="../src/assets/paduru.jpeg" alt="" className='rounded-tl-[0.75rem] rounded-tr-[0.75rem] rounded-br-[0] rounded-bl-[0] object-fill aspect-16:9'/>  */}
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQi3jhTMWfXGMDW7XNbDX0LWWqsgqM0heOCCw&s" alt="" className='rounded-tl-[0.75rem] rounded-tr-[0.75rem] rounded-br-[0] rounded-bl-[0] object-fill aspect-16:9'/> 
